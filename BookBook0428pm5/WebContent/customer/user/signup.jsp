                     ...
                     <div class="cols-sm-10">
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control" name="inputId"
                              id="inpudId" placeholder="아이디를 입력하세요" style="width=30px" maxlength="10"/> <span id="idCheck">중복체크
                              부분입니다.</span>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="cols-sm-10">
                        <div class="input-group">
                           <span class="input-group-addon"><i
                              ...
                              <div width=30px;> </div>
                              <div>
                              <input type="text" class="form-control" id="tel1" name="tel1" style="text-align:center; width:100px; height:30px;" maxlength="4">
                           
            
                               <input type="text" class="form-control" id="tel2" name="tel2" style="text-align:center; width:100px; height:30px;" maxlength="4" float="right">
                               
                               
                               <input type="text" class="form-control" id="tel3" name="tel3" style="text-align:center; width:100px; height:30px;" maxlength="4" float="right">
                     ...
                     <div class="cols-sm-10">
                        <div class="input-group">
                           <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"
                              aria-hidden="true"></i></span> 
                              <input type="text" class="form-control" id="userEmail1" name="userEmail1" placeholder="이메일 주소" style="text-align:center; width:150px; height:30px;">
                               
                              <input type="text" class="form-control" id="userEmail2"name="userEmail2" placeholder="이메일 주소" style="text-align:center; width:150px; height:30px;"> 
