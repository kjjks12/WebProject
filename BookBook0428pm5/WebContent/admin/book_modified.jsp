		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<p>
					<br>
					<!-- 폼시작 -->
				<form id="form" name="bookInfo"
					action="${pageContext.request.contextPath}/UpdateBookServlet"
					method="post" enctype="multipart/form-data">
					
					<div class="row">
						<div class="col-xs-5">
							<img id="book_img" width="400px" height="580px"
								src="${pageContext.request.contextPath}/bookimg/${book_detail_dto.bookDTO.bookCode}.jpg" />
						</div>
					
					<div class="col-xs-6">
					<div class="row">
					<div class="col-xs-2"><strong>I&nbsp;S&nbsp;B&nbsp;N&nbsp;:&nbsp;</strong></div>
						<div class="col-xs-6"><input type="text" class="form-control input-sm" name="isbn" value="${book_detail_dto.bookDTO.bookCode}" readonly></div>
					</div>
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm" name="book_name"
								value="${book_detail_dto.bookDTO.bookTitle}">
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm" name="author"
								value="${book_detail_dto.bookDTO.bookAuthor}">
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm" name="publisher"
								value="${book_detail_dto.bookDTO.bookPublisher}">
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm"
								name="publish_date" value="${book_detail_dto.bookDTO.bookDate}">
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm" name="page_num"
								value="${book_detail_dto.bookDTO.bookPage}" onkeyPress="InpuOnlyNumber(this);">
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm" name="price"
								value="${book_detail_dto.bookDTO.bookPrice}">
						</div>
					</div>
					<br>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm"
								name="book_category_code"
								value="${book_detail_dto.bookDTO.bookCategoryCode}">
						</div>
					</div>
					<br>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-xs-6">
							<input type="text" class="form-control input-sm" name="inventory"
								value="${book_detail_dto.bookDTO.bookInventory}">
						</div>
					</div>
					<br>
					<div class="row">
