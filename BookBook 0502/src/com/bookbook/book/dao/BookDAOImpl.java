...
public class BookDAOImpl implements BookDAO {
	...
	@Override
	   public List<BookDTO> getBookList(String keyField, String keyWord) {
	      Connection con = null;
	        PreparedStatement pstmt = null;
	        ResultSet rs = null;
	      List<BookDTO> list = new ArrayList<>();
	        //String sql = "SELECT book_code,book_title,book_author,book_price from(select * from book order by book_title)";
	        ...
	        sqlQeury.append("select * from book ");
	         ...
	         try{
	            ...
	            if(keyField.equals("book_title"))
	            {
	            	sqlQeury.append("where book_title ");
	            }
	            
	            else if(keyField.equals("book_author"))
	            {
	            	sqlQeury.append("where book_author ");
	            }
	            
	            else if(keyField.equals("book_publisher"))
	            {
	            	sqlQeury.append("where book_publisher ");
	            }
	            
	            if((!keyField.equals("all"))){
	            	sqlQeury.append(" LIKE '%"+keyWord.trim()+"%'");
	            }
	            sqlQeury.append("order by book_date asc");
...
*/
	            pstmt = con.prepareStatement(sqlQeury.toString());            
