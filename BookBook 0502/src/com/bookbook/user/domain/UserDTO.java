...
public class UserDTO {
	...
	public UserDTO(String userCode, String userPassword) {
		super();
	...
	public UserDTO(String userCode, String userName, String userPassword, String userTel, String userAddr,
			String userGender, String userBirth, String userEmail, String userPasswordHint, String userPasswordQuestion,
			String userPasswordAnswer, String userZipCode, String userLevel, String userCash) {
		super();
		this.userCode = userCode;
		this.userName = userName;
		this.userPassword = userPassword;
	...
	public String toString() {
		return "UserDTO [userCode=" + userCode + ", userName=" + userName + ", userPassword=" + userPassword
				...
				+ ", userZipCode=" + userZipCode + ", userLevel=" + userLevel + ", userCash=" + userCash + "]";
	}
