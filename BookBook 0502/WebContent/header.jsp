...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<div class="navbar-collapse collapse navbar-right">
		...
		<%-- 	<li><div class="col-md-5">${sessionScope.loggedInUser}님 반갑습니다.</div></li> --%>
			<li ><a href="${pageContext.request.contextPath}/start.jsp">홈</a></li>
			<li><c:choose>
			...
			<c:choose>
				<c:when test="${sessionScope.loggedInUser==null}">
					<li><a href="${pageContext.request.contextPath}/customer/user/signup.jsp">회원가입</a></li>
				</c:when>
			</c:choose>
	<%-- 		<li><a
		...
		<%-- 	<li><a href="${pageContext.request.contextPath}/customer/user/mypage.jsp">마이부크</a></li> --%>
			...
			<li><a href="${pageContext.request.contextPath}/Order">주문배송</a></li>
