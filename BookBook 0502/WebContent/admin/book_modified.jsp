					...
					<div class="row">
						...
						<div class="col-xs-6">
							<div class="row">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control input-sm" name="isbn"
										value="${book_detail_dto.bookDTO.bookCode}" readonly>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control input-sm" name="author"
										id="author" value="${book_detail_dto.bookDTO.bookAuthor}">
								</div>
							</div>
							<br>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control input-sm"
										...
										id="datepicker" value="${book_detail_dto.bookDTO.bookDate}">
								</div>
							</div>
							<br>
							<div class="row">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control input-sm"
										...
										value="${book_detail_dto.bookDTO.bookPage}"
							...
							<div class="row">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control input-sm" name="price"
										id="price" value="${book_detail_dto.bookDTO.bookPrice}">
								</div>
							</div>
							<br>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-xs-1">
									<select name="category_name" id="category_name">
										<c:forEach items="${CodeUtil.getChildCodes('04')}"
											var="code_number">
							...
							<div class="row">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control input-sm"
										name="book_category_code" id="book_category_code"
										value="${book_detail_dto.bookDTO.bookCategoryCode}" readonly>
								</div>
							</div>
							<br>
							<div class="row">
