		...
		<div class="container">
			<div class="row">
				<form class="form-horizontal" method="post"
					action="${pageContext.request.contextPath}/user?command=insert">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										...
										placeholder="아이디를 입력하세요" style="" maxlength="10" />
								</div>
								<!-- input group 끝 -->
								<div class="row">
									<span id="idCheck" style="color: red">중복체크 부분입니다.</span>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										id="inputPassword1" placeholder="비밀번호를 입력하세요." maxlength="10" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-lock fa-lg" aria-hidden="true"></i></span> <input
										type="password" class="form-control" name="inputPassword2"
										id="inputPassword2" placeholder="비밀번호를 입력하세요."
										onkeyup="passwordCheck()" maxlength="10" />
								</div>
								<div class="row">
									<span id="passwordCheck" style="color: red">비밀번호 일치 불일치
									</span>
								</div>
							</div>
						</div>
								...
								<span class="input-group-addon">
									<i class="glyphicon glyphicon-phone" aria-hidden="true"></i></span>
										<input type="text" id="tel1" name="tel1"
											...
											maxlength="4"> <b>-</b> <input type="text" id="tel2"
											name="tel2"
											style="text-align: center; width: 100px; height: 30px;"
											maxlength="4" float="right"> <b>-</b> <input
											type="text" id="tel3" name="tel3"
											style="text-align: center; width: 100px; height: 30px;"
											maxlength="4" float="right">
					...
					<div class="col-lg-5 col-lg-offset-2">
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										aria-hidden="true"></i></span> <input type="number" size="10"
										id="birthYear" name="birthYear" value="2017"
										style="text-align: left; width: 200; height: 25px;">년
									<select id="birthMonth" name="birthMonth"
										onchange="formChange()"
										style="text-align: left; width: 50px; height: 25px;"></select>월
									<select id="birthDay" name="birthDay"
										style="text-align: left; width: 50px; height: 25px;"></select>일
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										type="text" id="sample6_postcode" name="sample6_postcode"
										placeholder="우편번호"
										style="text-align: left; width: 280px; height: 25px;">
									<input type="button" onclick="sample6_execDaumPostcode()"
										name="birthYear" value="우편번호 찾기"
										style="text-align: left; width: 150px; height: 25px;"><br>
									<input type="text" id="sample6_address" name="sample6_address"
										placeholder="주소"
										style="text-align: center; width: 230px; height: 25px;">
									<input type="text" id="sample6_address2"
										name="sample6_address2" placeholder="상세주소"
										style="text-align: center; width: 210px; height: 25px;">
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										type="text" id="userEmail1" name="userEmail1"
										placeholder="이메일 주소"
										style="text-align: center; width: 150px; height: 30px;" /> <label
