							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="inputId"
										id="inpudId" placeholder="아이디를 입력하세요" /> <span id="idCheck">중복체크
										부분입니다.</span>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										...
										placeholder="비밀번호를 입력하세요." onkeyup="passwordCheck()" /> <span
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										type="text" class="form-control" id="tel1" name="tel1">

									<span> -</span> <input type="text" class="form-control"
										id="tel2" name="tel2"> <span> -</span> <input
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-lock fa-lg" aria-hidden="true"></i></span> <input
										type="number" size="10" id="birthYear" name="birthYear"
										value="2017">년 <select id="birthMonth"
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										onclick="sample6_execDaumPostcode()" name="birthYear"
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-lock fa-lg" aria-hidden="true"></i></span> <input
										type="text" class="form-control" id="userEmail1"
										name="userEmail1" placeholder="이메일 주소 "> @ <input
										type="text" class="form-control" id="userEmail2"
										name="userEmail2" placeholder="이메일 주소 "> <select
										name="email">
