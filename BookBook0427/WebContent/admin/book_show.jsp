				...
				<div class="box-body">
					<table id="example2" class="table table-bordered table-hover">
						...
						<c:forEach items="${list}" var="book_dto">
							<tr>
								<th>${book_dto.bookDTO.bookCode}</th>
								<th><a
									href="${pageContext.request.contextPath}/SelectBookServlet?book_code=${book_dto.bookDTO.bookCode}">${book_dto.bookDTO.bookTitle}</a></th>
								<th>${book_dto.bookDTO.bookCategoryName}</th>
								<th>${book_dto.bookDTO.bookPublisher}</th>
								<th>${book_dto.bookDTO.bookAuthor}</th>
								<th><fmt:formatNumber value="${book_dto.bookDTO.bookPrice}"
										pattern="#,###.##" />원</th>
								<th><fmt:formatNumber
										value="${book_dto.bookDTO.bookInventory}" pattern="#,###.##" />권</th>
