...
public class OrderDAOImpl implements OrderDAO {
	...
	public OrderDTO insertOrder(OrderDTO orderDTO) throws SQLException {
		...
		try{
			...
			//주문상세 정보 저장\
			System.out.println(insertOrderDetailSql);
			...
			System.out.println(bookInventorySql);
			...
			System.out.println(orderDTOResult);
