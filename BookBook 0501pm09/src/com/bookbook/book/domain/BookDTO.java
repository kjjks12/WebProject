...
public class BookDTO {
   ...
   public BookDTO(String bookCode, int bookPrice) {
	super();
	this.bookCode = bookCode;
	this.bookPrice = bookPrice;
}

public BookDTO(String bookCode, String bookTitle) {
	super();
	this.bookCode = bookCode;
	this.bookTitle = bookTitle;
}

public BookDTO(String bookCode, String bookTitle, int bookPrice) {
	super();
	this.bookCode = bookCode;
	this.bookTitle = bookTitle;
	this.bookPrice = bookPrice;
...
public BookDTO(String bookCode, String bookTitle, String bookAuthor, int bookPrice) {
   ...
   public BookDTO(String bookCode, String bookTitle, String bookAuthor, String bookPublisher, String bookDate,
		int bookPage, int bookPrice, String bookCover, String bookCategoryCode, int bookInventory, String bookUsed) {
	super();
	this.bookCode = bookCode;
	this.bookTitle = bookTitle;
	this.bookAuthor = bookAuthor;
